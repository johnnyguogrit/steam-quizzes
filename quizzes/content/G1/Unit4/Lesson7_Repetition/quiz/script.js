...
const explanations = {
    q1: "🎉 Correct! Repeat blocks are ORANGE!",
    q1_wrong: "🤔 Not quite. Repeat blocks are ORANGE - they help us repeat code!",
    q2: "🎉 Correct! Repeat blocks make our code shorter and more efficient!",
    q2_wrong: "🤔 Not quite. We use repeat blocks to make code SHORTER!",
    q3: "🎉 Correct! It will run exactly 3 times!",
    q3_wrong: "🤔 Not quite. The number on the repeat block tells how many times!",
    q4: "🎉 Correct! The blocks you want to repeat go INSIDE the repeat block!",
    q4_wrong: "🤔 Not quite. Put the blocks you want to repeat inside the repeat block!",
};
...
function showResults(score) {
    ...
    if (percentage === 1) {
        stars = '⭐⭐⭐⭐⭐';
        message = "AMAZING JOB! You're a Repetition Expert! 🏆";
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎉 G1 Repetition Quiz loaded!');
