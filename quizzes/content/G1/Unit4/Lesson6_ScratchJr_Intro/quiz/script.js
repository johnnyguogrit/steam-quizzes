...
const explanations = {
    q1: "🎉 Correct! Blue blocks are motion blocks - they make characters move!",
    q1_wrong: "🤔 Not quite. Motion blocks are BLUE - they make the cat move!",
    q2: "🎉 Correct! The green flag block STARTS your program running!",
    q2_wrong: "🤔 Not quite. The green flag is the STARTING block - tap it to run your code!",
    q3: "🎉 Correct! Order matters a LOT - blocks run one after another!",
    q3_wrong: "🤔 Not quite. Order is very important - blocks run in the order you put them!",
    q4: "🎉 Correct! We put blocks in the programming area at the bottom!",
    q4_wrong: "🤔 Not quite. Blocks go in the programming area below the stage!",
};
...
function showResults(score) {
    ...
    if (percentage === 1) {
        stars = '⭐⭐⭐⭐⭐';
        message = "AMAZING JOB! You're a ScratchJr Expert! 🏆";
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎉 G1 ScratchJr Quiz loaded!');
