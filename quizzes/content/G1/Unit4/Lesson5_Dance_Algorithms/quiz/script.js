...
const explanations = {
    q1: "🎉 Correct! The circle (○) represents spinning or turning around!",
    q1_wrong: "🤔 Not quite. The circle (○) means spin. ↑ means jump!",
    q2: "🎉 Correct! ↑↑ means jump twice, then ↔ means wave!",
    q2_wrong: "🤔 Not quite. ↑ means jump, so ↑↑↔ is jump, jump, wave!",
    q3: "🎉 Correct! Precision is very important in algorithms - robots do exactly what they're told!",
    q3_wrong: "🤔 Not quite. Robots cannot guess - they must follow the algorithm exactly!",
    q4: "🎉 Correct! The triangle pointing down (▽) represents stomp!",
    q4_wrong: "🤔 Not quite. ▽ means stomp. ～ means bend!",
};
...
function showResults(score) {
    ...
    if (percentage === 1) {
        stars = '⭐⭐⭐⭐⭐';
        message = "AMAZING JOB! You're a Dance Algorithm Expert! 🏆";
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎉 G1 Dance Algorithms Quiz loaded!');
