...
const explanations = {
    q1: "🎉 Correct! An algorithm is a set of step-by-step instructions like a recipe!",
    q1_wrong: "🤔 Not quite. An algorithm is step-by-step instructions - like how to make a sandwich!",
    q2: "🎉 Correct! Computers do EXACTLY what you tell them - they cannot guess!",
    q2_wrong: "🤔 Not quite. Computers cannot guess - they only do what you tell them exactly!",
    q3: "🎉 Correct! Good instructions are specific - Put the bread ON THE PLATE!",
    q3_wrong: "🤔 Not quite. Good instructions tell WHERE and HOW - 'Put the bread on the plate!'",
    q4: "🎉 Correct! Debugging means finding and fixing mistakes in your algorithm!",
    q4_wrong: "🤔 Not quite. Debugging is finding and fixing mistakes in your code or instructions!",
};
...
function showResults(score) {
    ...
    if (percentage === 1) {
        stars = '⭐⭐⭐⭐⭐';
        message = "AMAZING JOB! You're an Algorithm Expert! 🏆";
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎉 G1 Algorithms Quiz loaded!');
