...
const explanations = {
    q1: "🎉 Correct! Modern farming uses machines and robots to help with the work!",
    q1_wrong: "🤔 Not quite. Modern farming uses machines and robots - it's faster and easier!",
    q2: "🎉 Correct! Drones fly over farms to water plants and spray them with nutrients!",
    q2_wrong: "🤔 Not quite. Drones help by watering and spraying plants from above!",
    q3: "🎉 Correct! Sensors check food quality and sort items by size and color!",
    q3_wrong: "🤔 Not quite. Sensors check quality and sort food by size or color!",
    q4: "🎉 Correct! Technology helps us make food faster and more efficiently!",
    q4_wrong: "🤔 Not quite. We use technology to be faster, more efficient, and produce more food!",
};
...
function showResults(score) {
    ...
    if (percentage === 1) {
        stars = '⭐⭐⭐⭐⭐';
        message = "AMAZING JOB! You're a Technology Expert! 🏆";
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎉 G1 Computers in Food Quiz loaded!');
