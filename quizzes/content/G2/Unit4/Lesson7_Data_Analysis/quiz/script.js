...
const correctAnswers = {
    1: 'B',  // Bar chart shows data using bars of different lengths
    2: 'C',  // Most = tallest bar
    3: 'A',  // 5 > 3, so apples has more
    4: 'C',  // Least = smallest number
    5: 'B'   // Bar chart shows numbers as pictures/bars
};
