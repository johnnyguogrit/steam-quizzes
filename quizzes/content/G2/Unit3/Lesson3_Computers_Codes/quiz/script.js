const correctAnswers = {
    q1: 'B',  // Binary uses 0 and 1
    q2: 'B',  // 1 means On, 0 means Off
    q3: 'A',  // A pixel is a tiny dot that makes up images
    q4: 'B',  // Computers use binary because they use on/off switches
    q5: 'A'   // A pixel is a small dot that makes up images on screens
};
...
function showResults(score, total) {
    ...
    if (score === total) {
        ...
        messageText = 'Amazing! You are a Computer Whiz! 太棒了！你是电脑小天才！';
