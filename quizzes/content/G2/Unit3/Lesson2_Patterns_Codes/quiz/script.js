const correctAnswers = {
    q1: 'B',  // A->D means +3 shift, so B+3=E
    q2: 'B',  // Pattern alternates circle, square - next is square
    q3: 'A',  // K+2 = L, M (K is 11th letter, +2 = 13th = M)
    q4: 'B',  // Key is the secret pattern or rule
    q5: 'B'   // In +3 shift, A becomes D (A+3=B,C,D)
};
...
function showResults(score, total) {
    ...
    if (score === total) {
        ...
        messageText = 'Amazing! You are a Code Master! 太棒了！你是密码大师！';
