// Correct answers for Lesson 7 Quiz - Network Hardware
...
document.getElementById('quizForm').addEventListener('submit', function(e) {
    ...
    if (percentage === 100) {
        resultClass = 'perfect';
        message = 'Excellent! You are a Network Hardware Expert! | 太棒了！你是网络硬件专家！';
    } else if (percentage >= 80) {
        resultClass = 'good';
        message = 'Great job! You understand network hardware well! | 做得好！你很了解网络硬件！';
    } else if (percentage >= 60) {
        resultClass = 'good';
        message = 'Good effort! Keep learning about network hardware! | 继续努力！继续学习网络硬件知识！';
    } else {
