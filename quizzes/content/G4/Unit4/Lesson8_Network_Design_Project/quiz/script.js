// Correct answers for Lesson 8 Quiz - Network Design Project
...
document.getElementById('quizForm').addEventListener('submit', function(e) {
    ...
    if (percentage === 100) {
        resultClass = 'perfect';
        message = 'Excellent! You are a Network Design Expert! | 太棒了！你是网络设计专家！';
    } else if (percentage >= 80) {
        resultClass = 'good';
        message = 'Great job! You understand network design well! | 做得好！你很了解网络设计！';
    } else if (percentage >= 60) {
        resultClass = 'good';
        message = 'Good effort! Keep learning about network design! | 继续努力！继续学习网络设计知识！';
    } else {
